...
- Drive: dB
- Texture: 0.00 to 1.00
- Wow Depth: 0.00 to 1.00
- Wow Rate: Hz
- Tone: 0.00 to 1.00
- Mix: 0.00 to 1.00
- Output: dB
...
1. Keep perceived loudness level-matched while auditioning.
2. Bias presets toward musical enhancement, not extreme distortion.
3. Prioritize vocal and drum bus presets during first tuning pass.
